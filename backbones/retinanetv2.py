...
class RetinaNetV2(BackboneModel):
    ...
    def __init__(self, filepath=None):
        ...
        self.model = models.detection.retinanet_resnet50_fpn_v2(weights=models.detection.RetinaNet_ResNet50_FPN_V2_Weights.DEFAULT)
    ...
    def get_features(self, input_batch, key):
        ...
        def hook_feat_map(mod, inp, out):
            RetinaNetResnet50V2.extracted_features = out
        ...
        with torch.no_grad():
            ...
            handle.remove()
            return RetinaNetResnet50V2.extracted_features
