...
class FCOS(BackboneModel):
    ...
    def __init__(self, filepath=None):
        ...
        self.model = models.detection.fcos_resnet50_fpn(weights=models.detection.FCOS_ResNet50_FPN_Weights.DEFAULT)
    ...
    def get_features(self, input_batch, key):
        ...
        with torch.no_grad():
            ...
            handle.remove()
            return FCOS.extracted_features
